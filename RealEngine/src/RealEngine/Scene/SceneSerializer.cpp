...
#define READ_SCRIPT_FIELD(FieldType, Type)             \
	...
	static void SerializeEntity(YAML::Emitter& out, Entity entity) {
		...
		if (entity.HasComponent<CameraComponent>()) {
			...
			out << YAML::Key << "OrthographicNear" << YAML::Value << camera.GetOrthgraphicNearClip();
			out << YAML::Key << "OrthographicFar" << YAML::Value << camera.GetOrthgraphicFarClip();
		...
		if (entities) {
			for (auto entity : entities) {
				...
				if (cameraComponent) {
					...
					cc.Camera.SetOrthgraphicNearClip(cameraProps["OrthographicNear"].as<float>());
					cc.Camera.SetOrthgraphicFarClip(cameraProps["OrthographicFar"].as<float>());
