...
namespace RealEngine {
	...
	void ScriptEngine::InitMono() {
		...
		// Move this maybe
		s_Data->CoreAssembly = LoadCSharpAssembly("Resources/Scripts/RealEngine-ScriptCore.dll");
		PrintAssemblyTypes(s_Data->CoreAssembly);

		MonoImage* assemblyImage = mono_assembly_get_image(s_Data->CoreAssembly);
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "RealEngine", "Main");
